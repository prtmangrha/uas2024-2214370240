      ...
      <div class="col-lg-4 px-4 p-3 bg-white shadow p-3 mb-5 bg-body rounded" style="border-radius: 7px;">
        ...
        <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" class="px-3">
          <div class="form-group mb-2">
            ...
            <input type="text" name="username" class="form-control" placeholder="Masukkan Username" value="admin" required>
          </div>
          <div class="form-group mb-2">
            <label>Passowrd</label><br>
            <input type="password" name="password" class="form-control" placeholder="Masukkan Password" value="admin" required>
          </div>
          <div class="form-group mb-2">
